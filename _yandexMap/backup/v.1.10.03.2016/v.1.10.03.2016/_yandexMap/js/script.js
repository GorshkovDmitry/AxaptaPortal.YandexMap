...
//Html DOM constants
const POLIGON_SELECT_ID = "#poligon-select";
const POLIGON_OPTIONS_ID = "#poligon-options";
const POLIGON_NAME_ID = "#poligon-name";
const POLIGON_COLOR_ID = "#poligon-color";
const POLIGON_OPTIONS_SET_ID = "#poligon-options-set";
const POLIGON_DELETE_ID = "#poligon-del";
const FACTORY_NAME_ID = "#factory-name";
...
function deletePoligon()
{
	...
	$(POLIGON_SELECT_ID + " option[value='" + poligonId + "']").remove();
...
{
	poligonId = parseInt($(POLIGON_SELECT_ID).val());
	removePoligon();
